...
run_charts_i     = F; regionCompareOnly_i = 0; scenarioCompareOnly_i = 1;
run_boundaries_i = T;
run_bia_i        = F;
...
run_maps_i       = T; run_map_state_i = F;       run_map_GCAMbasin_i = T;  run_map_grid_i = F;
                      run_map_localShapeLocalData_i = F; run_map_localShapeGCAMData_i = F;
