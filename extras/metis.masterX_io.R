...
ioTable0=tibble::tribble( # Initial total demand
  ...
  "water_sw",        "water",        0,    150, 10,        30,         70,     0,      200,    2000, "km3", 2010,
  "water_import",     "water",       30,    10,  20,        50,         20,     200,    30,      0,  "km3", 2010,
  "elec_all",         "elec",        125,  0,   20,        70,         40,     1800,    50,     810, "TWh", 2010,
  "elec_import",      "elec",        30,   0,   10,        60,         30,     870,    10,      750, "TWh", 2010,
  "irri_corn",         "irri",        0,    3,  5,        0,          2,     0,      0,      5, "tons", 2010,
  "irri_import",      "irri",        0,    2,  7,        0,          1,     1,     0,       1, "tons", 2010,
  "live_cows",      "livestock",        0,    3,  3,        0,          60,     0,      0,      10, "tons", 2010,
  "live_lamb",      "livestock",        0,    2,  6,        0,          5,     0,     0,       5, "tons", 2010,
  "water_sw",        "water",       0,    200, 20,        40,         50,     0,      500,    1000, "km3", 2020,
  "water_import",     "water",       0,    20,  30,        20,         70,     300,    10,      0,  "km3", 2020,
  "elec_all",         "elec",        225,  0,   30,        40,         70,     1200,    30,     410, "TWh", 2020,
  "elec_import",      "elec",        50,   0,   20,        40,         50,     670,    20,      350, "TWh", 2020,
  "irri_corn",         "irri",        0,    30,  20,        0,          50,     0,      0,      100, "tons", 2020,
  "irri_import",      "irri",        0,    20,  20,        0,          50,     30,     0,       20, "tons", 2020,
  "live_cows",      "livestock",        0,    30,  20,        0,          50,     0,      0,      100, "tons", 2020,
  "live_lamb",      "livestock",        0,    20,  20,        0,          50,     30,     0,       20, "tons", 2020
);ioTable0


# Original Test
io1 <- metis.io(ioTable0=ioTable0, nameAppend = "_test",figWidth=7,figHeight=5); io1$ioTbl_Output %>% as.data.frame() ; io1$A_Output %>% as.data.frame()
...
ioTable0=tibble::tribble( # Initial total demand
  ...
  #
  "water_sw",        "water",        0,    10, 2,        4,         5,     0,      800,    100, "km3", "ScenB", "SubRegionA", 2010, "testRegion",
  "water_import",     "water",       50,   40,  30,        20,         70,     300,    10,      0,  "km3", "ScenB", "SubRegionA", 2010, "testRegion",
  "elec_all",         "elec",        225,  20,   60,        70,         90,     1500,    60,     610, "TWh", "ScenB", "SubRegionA", 2010, "testRegion",
  "elec_import",      "elec",        30,   0,   20,        40,         50,     670,    20,      350, "TWh", "ScenB", "SubRegionA", 2010, "testRegion",
  "irri_corn",         "irri",       0,    7.0,  2.0,        0,          5.0,     0,      0,      10.0, "tons", "ScenB", "SubRegionA", 2010, "testRegion",
  "irri_import",      "irri",        0,    1.0,  2.0,        0,          5.0,     3.0,     0,       2.0, "tons", "ScenB", "SubRegionA", 2010, "testRegion",
  #
  ...
  "irri_import",      "irri",        0,    35,  20,        0,          50,     30,     0,       20, "tons", "ScenB", "SubRegionB", 2010, "testRegion",
  # 2020
  ...
  #
  "water_sw",        "water",        0,    12, 12,        6,         5,     0,      10,    1000, "km3", "ScenB", "SubRegionB", 2020, "testRegion",
  "water_import",     "water",       0,    17,  3,        7,         5,     10,    30,      0,  "km3",  "ScenB", "SubRegionB", 2020, "testRegion",
  "elec_all",         "elec",        25,   0,   30,        40,         70,     1200,    30,     410, "TWh", "ScenB", "SubRegionB", 2020, "testRegion",
  "elec_import",      "elec",        11,  0,   25,        4,         50,     50,    10,      35, "TWh", "ScenB", "SubRegionB", 2020, "testRegion",
  "irri_corn",         "irri",       0,    170,  120,        0,          150,     0,      0,      1100, "tons", "ScenB", "SubRegionB", 2020, "testRegion",
  "irri_import",      "irri",        0,    135,  120,        0,          150,     130,     0,       120, "tons", "ScenB", "SubRegionB", 2020, "testRegion"
);ioTable0
