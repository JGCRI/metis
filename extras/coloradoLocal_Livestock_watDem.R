...
scaleRange_i=data.frame(param=c("livestock_water_demand"),
                        maxScale=c(5),
                        minScale=c(0))
numeric2Cat_param <- list("livestock_water_demand","param2")
...
list_index <- which(numeric2Cat_list$numeric2Cat_param=="livestock_water_demand")
