...
polygonDataTables_i=paste(getwd(),"/outputs/Maps/Tables/electricity_water_demand.csv",sep="")
...
scaleRange_i=data.frame(param=c("electricity_water_demand"),
                        maxScale=c(5),
                        minScale=c(0))
numeric2Cat_param <- list("electricity_water_demand","param2")
...
list_index <- which(numeric2Cat_list$numeric2Cat_param=="electricity_water_demand")
