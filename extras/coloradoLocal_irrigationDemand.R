...
polygonDataTables_i=paste(getwd(),"/outputs/Maps/Tables/irrigation_demand.csv",sep="")
...
scaleRange_i=data.frame(param=c("irrigation_demand"),
                        maxScale=c(5),
                        minScale=c(0))
numeric2Cat_param <- list("irrigation_demand","param2")
...
list_index <- which(numeric2Cat_list$numeric2Cat_param=="irrigation_demand")
