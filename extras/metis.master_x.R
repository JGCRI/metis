...
regionsSelect=c("Uruguay","Argentina","Colombia")
...
polyCatchmentBermejo1<-metis.grid2poly(grid=grid,
                                     boundaryRegShape=NULL,
                                     subRegShape=NULL,
                                     boundaryRegShpFolder=paste(getwd(),"/dataFiles/gis/admin_gadm36",sep=""),
                                     boundaryRegShpFile=paste("gadm36_0",sep=""),
...
polyCatchmentBermejo1RANDOM<-metis.grid2poly(grid=NULL,
                                     boundaryRegShape=NULL,
                                     subRegShape=NULL,
                                     boundaryRegShpFolder=paste(getwd(),"/dataFiles/gis/admin_gadm36",sep=""),
                                     boundaryRegShpFile=paste("gadm36_0",sep=""),
...
#polygonDataTables=polyBermeo3Cropped
...
param_i="demeterLandUse";x_i=2005
animateOn=T
delay=60
scenRef=NULL
...
metis.mapProcess(polygonDataTables=polyCatchmentBermejo1,
               gridDataTables=NULL,
               dirOutputs=paste(getwd(),"/outputs",sep=""),
               xRange=c(2010),
               labels=F,
