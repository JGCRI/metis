...
polygonDataTables_i=paste(getwd(),"/outputs/Maps/Tables/total_elec_supply.csv",sep="")
...
scaleRange_i=data.frame(param=c("total_elec_supply"),
                        maxScale=c(5),
                        minScale=c(0))
numeric2Cat_param <- list("total_elec_supply","param2")
...
list_index <- which(numeric2Cat_list$numeric2Cat_param=="total_elec_supply")
