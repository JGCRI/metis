...
if(TRUE){
# GCAM Scenarios
gcamdatabasePath_i <-"E:/Projects/NewAmerica/water-markets/output"
gcamdatabaseName_i <-"database_basexdb"
dataProj_i <-"GCAMdataProjChina.proj"
...
#localDBConn(gcamdatabasePath_i,gcamdatabaseName_i)

scenOrigNames_i <-c("1", "3")
scenNewNames_i <- c("Orig","New")
scenRef_i <- c("Orig")
}
...
run_grid2poly_i  = F; run_state_grid2poly_i = T; run_GCAMbasin_grid2poly_i = T; run_localShape_grid2poly_i = F;
run_maps_i       = F; run_map_state_i = F;       run_map_GCAMbasin_i = T;  run_map_grid_i = F;
