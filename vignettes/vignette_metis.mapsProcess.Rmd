...
<!-------------------------->
<!-------------------------->
# Pre-loaded Maps Selected
<p align="center"> <img src="vignetteFigs/metisHeaderThick.PNG"></p>
<!-------------------------->
<!-------------------------->

Sometimes subRegions can be present on multiple maps. Fo example "Colombia", China" and "India" are all members of `metis::mapGCAMReg32` as well as `metis::mapCountries`. If a user knows which map they want to plot their data on they should specify the map in the `subRegShape` argument.
