...
srn.colors <- function() {
    ...
    pal_16 <- c("#999999", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7", "#333333",
    ...
    pal_Diff <- c("#693C01", "#815A3D", "#9C7D6A", "#BDA89D", "white", "#ACAABF", "#8480A2", "#635D8B", "#473E7A")

    pal_Diff5 <- c("#693C01", "#9C7D6A", "white", "#8480A2", "#473E7A")

    pal_Absolute <- rev(c("#67001F", "#8C0C25", "#B2182B", "#C43C3C", "#D6604D", "#E58267", "#F4A582", "#F8C0A4",
    ...
    pal_Unassigned <- rep(unlist(mapply(brewer.pal, qual_col_pals$maxcolors, rownames(qual_col_pals))), 100)


    # Color scheme for electricity generation by aggregate fuel
    pal_elec_subsec <- c(coal = "#a0237c", gas = "#25a9e0", oil = "#d01c2a", biomass = "#00931d", nuclear = "#ef8e27",
    ...
    pal_elec_finalNrgFuel <- c(`3 coal` = "#a0237c", `2 gas` = "#25a9e0", `4 biomass` = "#00931d", `1 liquids` = "#000000",
    ...
    pal_finalNrg_sec <- c(building = "#facda4", `comm non-building` = "#ff230e", industry = "#cef4d1", transportation = "#d0f6f7",
    ...
    return(list(
      pal_16	=	pal_16	,
      elec_tech_colors	=	       elec_tech_colors	,
      elec_renew_colors	=	       elec_renew_colors	,
      building_colors	=	       building_colors	,
      trn_fuel_colors	=	       trn_fuel_colors	,
      enduse_fuel_numbered	=	       enduse_fuel_numbered	,
      enduse_colors	=	       enduse_colors	,
      pal_pri_ene	=	       pal_pri_ene	,
      pal_pri_fuelcost	=	       pal_pri_fuelcost	,
      pal_emiss_sector	=	       pal_emiss_sector	,
      pal_landuse	=	       pal_landuse	,
      pal_hydrogen	=	       pal_hydrogen	,
      pal_refliq	=	       pal_refliq	,
      emiss_by_enduse_colors	=	       emiss_by_enduse_colors	,
      biouse_colors	=	       biouse_colors	,
      pal_Basic	=	       pal_Basic	,
      pal_Gas	=	       pal_Gas	,
      pal_Diff	=	       pal_Diff	,
      pal_Diff5	=	       pal_Diff5	,
      pal_Absolute	=	       pal_Absolute	,
      pal_Absolute5	=	       pal_Absolute5	,
      pal_Unassigned	=	       pal_Unassigned	,
      pal_elec_subsec	=	       pal_elec_subsec	,
      pal_elec_finalNrgFuel	=	       pal_elec_finalNrgFuel	,
      pal_elec_techs	=	       pal_elec_techs	,
      pal_elec_sec	=	       pal_elec_sec	,
      pal_finalNrg_sec	=	       pal_finalNrg_sec	,
      pal_pri_ene	=	       pal_pri_ene	,
      pal_elec_tech_colors	=	       pal_elec_tech_colors
      ))
}
