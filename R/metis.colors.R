...
metis.colors <- function(palx=NULL) {
  ...
  add.alpha <- function(col, alpha=1){
    ...
    pal_metis <- c(`a Coal` = "gray40",  `c coal` = "gray40", `3 coal` = "gray40", coal = "gray40", `coal (conv pul)` = "gray40",
                 ...
                 #--------------
                 `heat`="darkslategray",
                 `6 hydrogen` = "orange", `hydrogen` = "orange",`Hydrogen Production and Refining` = "black",
                 ...
                 Agriculture = "green2", agriculture = "green2", Ag = "green2", AG = "green2", Agri = "green2",
                 ag = "green2", crops='green2', Crops='green2',
