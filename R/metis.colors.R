...
metis.colors <- function(palx=NULL) {
  ...
  add.alpha <- function(col, alpha=1){
    ...
    pal_metis <- c(`a Coal` = "gray40",  `c coal` = "gray40", `3 coal` = "gray40", coal = "gray40", `coal (conv pul)` = "gray40",
                 ...
                 Agriculture = "green3", agriculture = "green3", Ag = "green3", AG = "green3", Agri = "green3",
                 ag = "green3", crops='green3', Crops='green3',
    ...
    metisPalettes <-list(pal_metis=pal_metis,pal_16 = pal_16,
                         ...
                         pal_ColoradoLandAlloc=pal_ColoradoLandAlloc,
