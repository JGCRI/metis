      ...
      print(paste("Skipping electricity generation distribution with bia",sep=""))}else {
        ...
        for(biaInputsFile_i in biaInputsFiles){
          ...
          if(!file.exists(paste(biaInputsFolder,"/",biaInputsFile_i,sep=""))){
            ...
            gridx<-data.table::fread(paste(biaInputsFolder,"/",biaInputsFile_i,sep=""), header=T,stringsAsFactors = F)%>%
            ...
            gridWRI<-data.table::fread(paste(biaInputsFolder,"/",biaInputsFile_i,".csv",sep=""), header=T,stringsAsFactors = F)
